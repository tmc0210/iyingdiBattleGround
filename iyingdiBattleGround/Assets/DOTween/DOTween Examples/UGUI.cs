...
public class UGUI : MonoBehaviour
{
    ...
    void Start()
	{
        ...
        sequence.Insert(0, text.DOText("This text will replace the existing one", 2))
            .Insert(0, relativeText.DOText(" - This text will be added to the existing one", 2).SetRelative())
            .Insert(0, scrambledText.DOText("This text will appear from scrambled chars", 2, true, ScrambleMode.All))
